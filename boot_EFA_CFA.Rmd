...
```{r}
# Set file path
path <- "/Users/davidevans/Library/CloudStorage/OneDrive-Personal/My Projects/UBham/G-TSK development/Data/"

data_file <- "ADLInterferenceAndAt-GTSK_DATA_2023-10-13_1447.csv"
...
plot_response_distribution <- function(data, columns, plot_title, save_path) {
  ...
  print(p)
  ggsave(save_path, plot = p, width = 10, height = 8)
}
