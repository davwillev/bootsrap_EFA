...
```{r}
# Set file path
path <- "/Users/davidevans/Library/CloudStorage/OneDrive-Personal/My Projects/UBham/Disability attribution/Analyses/Factor analysis/6-item_ADLInterferenceAndAt-UniversalDisabilityI_DATA_2023-08-31_1142.csv"
...
boot_iterations <- 5000 # Set to 1000 or more
...
```{r}
  ...
  # Save summary to a CSV file
  write.csv(summarized_residuals, "Residuals.csv", row.names = FALSE)
